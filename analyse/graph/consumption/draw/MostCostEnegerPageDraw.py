...
from analyse.graph.GrapgNameSapce import GRAPH_app_page_consumption
...
grouped_data = data.groupby([data.iloc[:, user_idx_col], data.iloc[:, phone_brand_col],
...
output.to_excel("most_cost_energy_page_output.xlsx", index=False)
