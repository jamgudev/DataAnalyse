...
plt.plot(x, mean, 'o-', label='均值', color=AppColor.C_9_1[1])
plt.plot(x, lower_ci, '_', label='CI下限')
...
save_path = os.path.join(current_dir, 'GRAPH_unit_consumption_with_ci.png')
