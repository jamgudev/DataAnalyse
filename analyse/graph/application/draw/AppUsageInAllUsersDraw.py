...
custom_colors = [
    "#FF0000", "#B7FD01", "#0000FF", "#FFF000", "#E2DA34", "#7FFF00", "#F0F0F0", "#F000F0", "#00F0F0", "#0F0F0F",
    "#CC0000", "#00CC00", "#0000CC", "#A39D24", "#00CCCC", "#E54444", "#C0C0C0", "#0177FF", "#00C0C0", "#D0D2FF",
    "#00688C", "#FB8282", "#FFFF11", "#111FFF", "#7E84FF", "#1FFF00", "#100FF0", "#FF001F", "#6FFF0F", "#F6F60F",
    "#880000", "#008800", "#000088", "#888000", "#008888", "#880080", "#808080", "#FF1493", "#008080", "#FF6347",
    "#7FFF00", "#FF69B4", "#FE8D00", "#D27B68", "#8B008B", "#00EA6A", "#FF4500", "#48D1CC",
]
...
for i, app in enumerate(apps):
    ...
    if app == "Other":
        ...
        ax.bar(range(1, len(users) + 1), app_ratios.values, bottom=bottom, label=app, color=custom_colors[i])
    bottom += app_ratios
...
ax.set_xlim(0, 46)
# 调整图表和标签的位置
plt.subplots_adjust(top=0.96, left=0.05, right=0.95, bottom=0.25)
